...
fn test_list_count_method() {
    ...
    assert!(
        thir.types.values().any(|t| *t == typecheck::Ty::Int),
...
fn test_list_is_empty_method() {
    ...
    assert!(
        thir.types.values().any(|t| *t == typecheck::Ty::Bool),
