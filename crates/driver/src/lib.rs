...
/// pass. See `docs/stdlib-loading-unification.md`.
pub fn check_modules(modules: &[(&str, &str)]) -> axiom_typeck::Thir {
    ...
    axiom_typeck::check_with_lang_items(hir, lang_items)
}
...
pub fn check_source(source: &str) -> axiom_typeck::Thir {
